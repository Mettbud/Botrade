 ...
 * mean "no cap" - used for every scoped/global STOP_LOSS and PANIC_EXIT, where getting out of a bad
 ...
 * PROFIT_LOCK is treated like STOP_LOSS: once its protected floor is hit,
 * delaying the exit for spread would defeat the purpose of the floor.
 */
